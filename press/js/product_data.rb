  ...
  PRODUCT_DATA = T.let(
    [
      ...
      Book.new(
        ...
        buyPath: 'https://www.amazon.com/dp/1953953166',
        zine: Zine.new(
          cover: 'https://images.ctfassets.net/fzn2n1nzq965/2rrvfUSUQfZA4ukboUlQSs/e51009e67d65a9cc0196b28e4cdb03a1/TBS_zine.png?fm=webp&q=60&w=800',
        ...
        material: BookMaterial.new(
          shininess:        8,
          thickness:        1.4,
          diffuseMapCustom: 'TBS_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.04,
          bumpMapCustom:    'TBS_bump.webp',
          bumpScaleCustom:  0.14,
          foilMap:          'TBS_foil.webp',
          foilDetail:       2.5,
          foilSpecular:     1,
          foilOpacity:      1.8,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        10,
          thickness:        0.8,
          diffuseMapCustom: 'SF_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.03,
          bumpMapCustom:    'SF_bump.webp',
          bumpScaleCustom:  0.02,
          foilMap:          'SF_foil.webp',
          foilDetail:       4,
          foilOpacity:      1.5,
          foilSpecular:     1.5,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        8,
          thickness:        0.8,
          diffuseMapCustom: 'WIP_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.04,
          bumpMapCustom:    'WIP_bump.webp',
          bumpScaleCustom:  0.1,
          foilMap:          'shared_foil_none.webp',
        ),
      ),
      Book.new(
        slug: 'where-is-my-flying-car',
        ...
        material: BookMaterial.new(
          shininess:        12,
          thickness:        1.4,
          diffuseMapCustom: 'TADSE_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.05,
          bumpMapCustom:    'TADSE_bump.webp',
          bumpScaleCustom:  0.10,
          foilMap:          'TADSE_foil.webp',
          foilDetail:       1,
          foilSpecular:     1,
          foilOpacity:      0.75,
        ),
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        10,
          thickness:        1.3,
          diffuseMapCustom: 'POP_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.05,
          bumpMapCustom:    'POP_bump.webp',
          bumpScaleCustom:  0.1,
          foilMap:          'shared_foil_none.webp',
        ),
      ),
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        15,
          thickness:        0.8,
          diffuseMapCustom: 'GT_diffuse.webp',
          bumpMapBase:      'shared_bump_paper.webp',
          bumpScaleBase:    0.07,
          bumpMapCustom:    'GT_bump.webp',
          bumpScaleCustom:  0.10,
          foilMap:          'GT_foil.webp',
          foilDetail:       1.5,
          foilSpecular:     -0.75,
        )
      ),
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        8,
          thickness:        1.4,
          diffuseMapCustom: 'AEP_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.04,
          bumpMapCustom:    'AEP_bump.webp',
          bumpScaleCustom:  0.05,
          foilMap:          'AEP_foil.webp',
          foilDetail:       1,
          foilSpecular:     1,
          foilOpacity:      1.4,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        15,
          thickness:        1.4,
          diffuseMapCustom: 'ROTP_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.07,
          bumpMapCustom:    'ROTP_bump.webp',
          bumpScaleCustom:  0.10,
          foilMap:          'ROTP_foil.webp',
          foilDetail:       2,
          foilSpecular:     -1,
          foilOpacity:      1.2,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        14,
          thickness:        0.8,
          diffuseMapCustom: 'SA_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.03,
          bumpMapCustom:    'SA_bump.png',
          bumpScaleCustom:  0.2,
          foilMap:          'SA_foil.webp',
          foilDetail:       4,
          foilSpecular:     13.75,
          foilOpacity:      0.2,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        10,
          thickness:        1.4,
          diffuseMapCustom: 'TDM_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.05,
          bumpMapCustom:    'TDM_bump.webp',
          bumpScaleCustom:  0.10,
          foilMap:          'TDM_foil.webp',
          foilDetail:       1,
          foilSpecular:     -1.7,
          foilOpacity:      0.8,
        )
      ...
      Book.new(
        ...
        material: BookMaterial.new(
          shininess:        10,
          thickness:        1.4,
          diffuseMapCustom: 'HGH_diffuse.webp',
          bumpMapBase:      'shared_bump_buckram.webp',
          bumpScaleBase:    0.05,
          bumpMapCustom:    'HGH_bump.webp',
          bumpScaleCustom:  0.3,
          foilMap:          'shared_foil_none.webp',
        )
      ),
