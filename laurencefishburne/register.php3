  ...
  <tr> 
    <td colspan=2 width=49 align=center valign=top> 
      <table width=49 cellspacing=0 cellpadding=0 border=0>
        <tr> 
          <td colspan=2 width=49 align=right valign=top background=images/alpha.gif><a href="register.php3"><img src="images/mouseovers/register_photo_over.gif" width="47" height="28" alt="register" border="0" name="registerphoto"></a></td>
        </tr>
        <tr> 
          <td colspan=2 width=49 align=right valign=top background=images/alpha.gif><a href="register.php3"><img src="images/mouseovers/register_over.gif" width="47" height="9" alt="register" border="0" name="register" vspace=1></a><br>
          </td>
        </tr>
      </table>
    </td>
